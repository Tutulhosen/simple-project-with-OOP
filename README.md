##  A simple project with OOP
Its like a user info project

<img src="photo.png">

#### Our features
- Have a SignUp form and sent all data into database from the form
- select all data from database and display
